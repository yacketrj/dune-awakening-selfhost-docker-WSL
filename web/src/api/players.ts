...
export const playersApi = {
  ...
  giveItems: (playerId: string, items: { itemName?: string; itemId?: string; quantity: number; durability?: number }[], options: { historyScope?: string; historyFriendly?: string } = {}) => post<{ ok: boolean; results: Record<string, unknown>[] }>(`/api/players/${encodeURIComponent(playerId)}/give-items`, { items, ...options }),
