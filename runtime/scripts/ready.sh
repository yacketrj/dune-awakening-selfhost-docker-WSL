...
check_tcp "${RMQ_ADMIN_HOST_PORT:-32573}" "RabbitMQ admin localhost" "dune-rmq-admin"
check_tcp "${RMQ_GAME_HOST_PORT:-31982}" "RabbitMQ game public" "dune-rmq-game"
check_tcp "${RMQ_GAME_HTTP_HOST_PORT:-31983}" "RabbitMQ game HTTP public" "dune-rmq-game"
