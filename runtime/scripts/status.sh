...
rmq_admin_tcp="$(check_tcp "${RMQ_ADMIN_HOST_PORT:-32573}")"
rmq_game_tcp="$(check_tcp "${RMQ_GAME_HOST_PORT:-31982}")"
rmq_game_http_tcp="$(check_tcp "${RMQ_GAME_HTTP_HOST_PORT:-31983}")"
...
printf "%-24s %-8s %s\n" "RabbitMQ admin" "${RMQ_ADMIN_HOST_PORT:-32573}/tcp" "$rmq_admin_tcp"
printf "%-24s %-8s %s\n" "RabbitMQ game" "${RMQ_GAME_HOST_PORT:-31982}/tcp" "$rmq_game_tcp"
printf "%-24s %-8s %s\n" "RabbitMQ game HTTP" "${RMQ_GAME_HTTP_HOST_PORT:-31983}/tcp" "$rmq_game_http_tcp"
