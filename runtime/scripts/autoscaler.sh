...
GENERATED_DIR="${DUNE_GENERATED_DIR:-runtime/generated}"
STATE_FILE="${DUNE_AUTOSCALER_STATE_FILE:-${GENERATED_DIR}/autoscaler-idle.tsv}"
SERVER_ID_MAP_FILE="${DUNE_AUTOSCALER_SERVER_ID_MAP_FILE:-${GENERATED_DIR}/autoscaler-server-ids.tsv}"
DEMAND_FILE="${DUNE_AUTOSCALER_DEMAND_FILE:-${GENERATED_DIR}/autoscaler-demand.tsv}"
HUB_TRAVEL_FILE="${DUNE_AUTOSCALER_HUB_TRAVEL_FILE:-${GENERATED_DIR}/autoscaler-hub-travel.tsv}"
DEEPDESERT_TRAVEL_FILE="${DUNE_AUTOSCALER_DEEPDESERT_TRAVEL_FILE:-${GENERATED_DIR}/autoscaler-deepdesert-travel.tsv}"
DIRECTOR_HEAL_FILE="${DUNE_AUTOSCALER_DIRECTOR_HEAL_FILE:-${GENERATED_DIR}/autoscaler-director-heal.tsv}"
...
ensure_state_file "$SERVER_ID_MAP_FILE"
ensure_state_file "$DEMAND_FILE"
ensure_state_file "$HUB_TRAVEL_FILE"
ensure_state_file "$DEEPDESERT_TRAVEL_FILE"
ensure_state_file "$DIRECTOR_HEAL_FILE"
