...
export function taskTimeoutMs(config, operation) {
  if (["start", "stop", "restartAll", "restartService", "serverTitle", "init", "updateApply", "updateFixSteamcmd", "selfUpdateApply", "selfUpdatePrevious", "backupRestore", "worldPartitionsRepair", "userSettingsSaveAndRestart", "userSettingsResetAndRestart", "userSettingsRawAndRestart", "mapsApplySettings"].includes(operation)) {
